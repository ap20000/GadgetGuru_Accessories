...
public class ApiClient {
    ...
    private static final String BASE_URL = "http://192.168.18.12/api/";
        ...
        apiService.loginUser(user).enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 404) { // Assuming 404 is the error code for username not found
                    ...
                    } else if (response.code() == 401) { // Unauthorized - Incorrect username or password
